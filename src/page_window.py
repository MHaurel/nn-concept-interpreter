...
class PageWindow(QMainWindow):
    gotoSignal = Signal(str, object, str, object)
    layout = QHBoxLayout()

    def goto(self, name, dataloader=None, category=None, sample=None):
        """
        ...
        :param sample: the sample we want to transfer to the next window
        :return: None
        """
        self.gotoSignal.emit(name, dataloader, category, sample)
